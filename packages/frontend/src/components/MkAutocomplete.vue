...
import { chat2pathSelector, char2twemojiFilePath, char2fluentEmojiFilePath } from '@@/js/emoji-base.js';
...
const unicodeEmojiDB = computed(() => {
	...
	const char2path = chat2pathSelector(prefer.r.emojiStyle.value);
